              ...
              contents: [
                {
                  ...
                  hero: {
                    type: 'image',
                    url: `${origin}/images/duty_check_carousel.jpg?v=3`,
                    size: 'full',
                    aspectRatio: '1:1',
                    aspectMode: 'cover',
                    action: {
                ...
                },
                {
                  ...
                  hero: {
                    type: 'image',
                    url: `${origin}/images/link_account_carousel.jpg?v=3`,
                    size: 'full',
                    aspectRatio: '1:1',
                    aspectMode: 'cover',
                    action: {
                      type: 'uri',
                      label: 'จัดการบัญชี',
                      uri: process.env.NEXT_PUBLIC_LIFF_ID ? `https://liff.line.me/${process.env.NEXT_PUBLIC_LIFF_ID}/` : 'https://liff.line.me/2011067034-H9LnJMX7'
                    }
                  }
                },
                {
                  ...
                  hero: {
                    type: 'image',
                    url: `${origin}/images/meterbill_carousel.jpg?v=3`,
                    size: 'full',
                    aspectRatio: '1:1',
                    aspectMode: 'cover',
                    action: {
